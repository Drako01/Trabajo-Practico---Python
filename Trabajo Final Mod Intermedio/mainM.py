...
# ############# CREAR BASE DE DATOS
def conectar():#conectar a la base editar nombre de base
    try:
...
def crearbase():#crear base de datos editar nombre de base de datos

    try:
        con = sqlite3.connect('mibase.db')
        print("Ya esta Creada la Base de Datos sqlite3  Agenda_Contactos")
    except Error:
        print(Error)
    finally:
        con.close()
...
def creartabla(con):#crear tabla editar nombres de id de tablas
